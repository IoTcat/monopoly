...
cls
echo compiling...
g++ -O2 -o monopoly src/main.cpp src/controller.cpp src/food.cpp src/roll.cpp src/square.cpp src/msgbox.cpp src/hintbox.cpp src/map.cpp src/point.cpp src/snake.cpp src/startinterface.cpp src/tools.cpp lib/ovo.h -std=c++11 -fexec-charset=utf-8
